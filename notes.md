...
- Πίνακας με τις καταχωρημένες αιτήσεις
  - Κλικ σε μια εγγραφή -> μετάβαση στην περιγραφή της εγγραφής (στοιχεία αιτούντα)
- Λήξη της προθεσμίας
  - Ενεργοποίηση μοριοδότησης αιτήσεων από τον υπάλληλο
    - Π.χ ένα κουμπί στο Admin panel
    - Ένας loader και setTimeout για sleep (ένδειξη εκτέλεσης διαδικασίας)
- Μετά τη μοριοδότηση
...
- Ενημέρωση του υπαλλήλου για την ολοκλήρωση της διαδικασίας
</br>
</br>
**NEEDS REVIEW**
Admin page
